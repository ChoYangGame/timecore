...
| 4시대 근접 몹 걷기 각 6프레임 (랩터 · 기사 · 로봇 · 스토커) + 오브젝트 3종 (모래시계 · 총알 · 보스탄) + 시대별 포탑·탄 각 4종 | 2026-08-09~10 디자인 담당이 전달 (기사: 3×2 시트 1920×720 보라 크로마키 / 랩터·로봇·스토커: 낱장 1280×720 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 직접 그린 것인지 AI 생성인지, AI라면 어느 모델인지 기재해야 한다 | 근접 몹 애니메이션 (`Assets/Art/Enemies/` — raptor 420 KB / knight 319 KB / robot 403 KB / stalker 322 KB, 전부 세로 192px = 1유닛) + `Assets/Art/Objects/` 모래시계·총알·보스탄·시대별 포탑 4 + 포탑탄 4 |
| 근접무기 시간의 홀(Energy Scepter) 휘두르기 10프레임 | 2026-08-10 디자인 담당이 전달 (1280x720 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 위 몹·보스·플레이어 아트와 같은 경로로 받았다 | 칼잡이 무기 그림 겸 히트박스 (`Assets/Art/Player/scepter_swing_0~9.png` — 208 KB) |
| EXP 구슬 (결정 구체 1장) | 2026-08-10 디자인 담당이 전달 (1254x1254 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 위 몹·보스·플레이어 아트와 같은 경로로 받았다 | 경험치 오브 (`Assets/Art/Objects/exp_orb.png` — 31 KB) |
| 플레이어 호버 6프레임 + 거너폼 총(Chrono Blaster) 발사 8프레임 | 2026-08-10 디자인 담당이 전달 (낱장 1280×720 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 위 몹·보스 아트와 같은 경로로 받았다 | 플레이어 캐릭터·거너 무기 (`Assets/Art/Player/` — 호버 430 KB / 총 294 KB) |
| 4시대 보스 애니메이션 (티렉스 6 · 기사 6 · 전차 6 · 시계 코어 8, 총 26프레임) | 2026-08-10 디자인 담당이 전달 (낱장 1280×720 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 위 몹 아트와 같은 경로로 받았다 | 보스 애니메이션 (`Assets/Art/Bosses/` — primitive 769 KB / medieval 580 KB / modern 939 KB / future 1301 KB, 전부 세로 256px = 1유닛) |
