...
| 4시대 근접 몹 걷기 각 6프레임 (공룡 · 기사 · 로봇 · 스토커) | 2026-08-09~10 디자인 담당이 전달 (공룡: 낱장 1276×691, 기사: 3×2 시트 1920×720 보라 크로마키, 로봇·스토커: 낱장 1280×720 **투명 PNG**) | **제작 방식 미확인 — 제출 전 확인 필요.** 직접 그린 것인지 AI 생성인지, AI라면 어느 모델인지 기재해야 한다 | 근접 몹 애니메이션 (`Assets/Art/Enemies/` — dino 759 KB / knight 319 KB / robot 403 KB / stalker 322 KB, 전부 세로 192px = 1유닛) |
