...
| EXP 구슬 (결정 구체 1장) | 2026-08-10 디자인 담당이 전달 (1254x1254 **투명 PNG**) | 팀 자체 제작(생성형 AI) — **Codex GPT-5.6 Sol (high)** 정지 원화 (애니메이션 없음) | 경험치 오브 (`Assets/Art/Objects/exp_orb.png` — 31 KB) |
...
| 메인 화면 배경 아트 (시간관리국 홀) | 2026-08-10 디자인 담당이 전달 (1672×941 PNG, 원본 1.8 MB) | 팀 자체 제작(생성형 AI) — **Codex GPT-5.6 Sol (high)** 정지 원화 (애니메이션 없음) | 타이틀·직업 선택 화면 배경 (`Assets/Art/UI/title_bg.png` — 1280×720로 축소, DXT1 **450 KB**) |
| 장판 아트 2종 (감속 장판 · 매지션 공격 장판) | 2026-08-10 디자인 담당이 전달 (1024×1024 / 1536×1024 투명 PNG) | 팀 자체 제작(생성형 AI) — **Codex GPT-5.6 Sol (high)** 정지 원화 | 시간 감속 지대 · 매지션 지대 (`Assets/Resources/FX/slow_field.png` 512² DXT5 256 KB / `timestop_field.png` 768×512 DXT5 384 KB) |
