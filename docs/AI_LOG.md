...
| 원시 시대 공룡 · 중세 시대 기사 걷기 각 6프레임 | 2026-08-09~10 디자인 담당이 전달 (공룡: 낱장 1276×691 / 7.3 MB, 기사: 3×2 시트 1920×720) | **제작 방식 미확인 — 제출 전 확인 필요.** 직접 그린 것인지 AI 생성인지, AI라면 어느 모델인지 기재해야 한다 | 근접 몹 애니메이션 (`Assets/Art/Enemies/primal_dino_0~5.png` 256×192 / 759 KB, `medieval_knight_0~5.png` 200×192 / 319 KB) |
